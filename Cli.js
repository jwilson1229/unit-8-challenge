...
class Cli {
  ...
  constructor(vehicles: (Car | Truck | Motorbike)[]) {
    this.vehicles = vehicles; // Assign the vehicles array
  }
    ...
    inquirer
      ...
      .then((answers) => {
        if (this.vehicles instanceof Truck) {
          ...
          console.log('Vehiicle is being towed!');
        }
      ...
      .then((answers) => {
        ...
        if (answers.action === 'Print details') {
          ...
          if (selectedVehicle instanceof Motorbike) {
            ...
            console.log('This bike is doing a wheelie!');
          } else {
            console.log('Only a motorbike can perform a wheelie!');
          }
        } else if (answers.action === 'Pull a Materand Tow!') {
          const selectedVehicle = this.vehicles.find(vehicle => vehicle.vin === this.selectedVehicleVin);
          if (selectedVehicle instanceof Truck) {
            console.log('A truck cannot tow itself!');
          } else if (selectedVehicle) {
            console.log('This truck is towing something heavy!');
          } else {
            console.log('No vehicle selected or the selected vehicle cannot be towed.');
          }
        }
